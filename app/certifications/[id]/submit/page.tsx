...
const GSA_MAS_CHECKLIST = [
  ...
  { id: "csp1", label: "6. CSP-1 Pricelist (Excel)", section: "upload", field: null,
    what: "Your proposed pricing in GSA's CSP-1 format with labor categories, MFC pricing, and proposed GSA rates.",
    where: "GovCert's Pricing page builds this. The CSP-1 Excel is auto-generated from your labor categories.",
    sbaPortal: "eOffer → Upload Documents. Upload the .xlsx file.",
    format: "Excel (.xlsx). Generated by GovCert from your Pricing page LCATs.",
    docCategory: "CSP1_GENERATED",
  },
  ...
  { id: "subconPlan", label: "9. Subcontracting Plan (if >$750K & not small biz)", section: "upload", field: null,
  ...
  { id: "corpExperience", label: "10. Corporate Experience Narrative (paste into eOffer)", section: "narrative", field: null,
  ...
  { id: "qcp", label: "11. Quality Control Plan (paste into eOffer)", section: "narrative", field: null,
  ...
  { id: "sinNarratives", label: "12. Relevant Project Experience (1 per SIN, paste into eOffer)", section: "narrative", field: null,
