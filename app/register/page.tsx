    ...
    <div style={{ minHeight: "100vh", background: "var(--navy)", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 480, padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ color: "rgba(255,255,255,.5)", fontSize: 14, fontWeight: 300 }}>Create your account</p>
        </div>
        ...
        <div style={{ background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.09)", borderRadius: 12, padding: "40px 36px", backdropFilter: "blur(12px)" }}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 18 }}>
              <div>
                <label style={{ display: "block", fontSize: 12, fontWeight: 500, color: "rgba(255,255,255,.5)", marginBottom: 7, textTransform: "uppercase", letterSpacing: ".08em" }}>First Name</label>
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, fontWeight: 500, color: "rgba(255,255,255,.5)", marginBottom: 7, textTransform: "uppercase", letterSpacing: ".08em" }}>Last Name</label>
